...
def trova_percorso(ambiente, q_table):
    # Faccio partire il percorso finale da un punto casuale
    stato, _ = ambiente.reset()
...
percorso = trova_percorso(ambiente, q_table)                     # Trovo il percorso migliore da una partenza casuale.
